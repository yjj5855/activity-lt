  ...
  <div>
    <div class="index-page">
      ...
      <div style="position: relative;" v-if="firstVisibility">
        ...
        <div class="c-p" style="position: absolute; top: 45%;left: 32%;width: 17%;height: 12%;" @click="goUrl('http://dwz.cn/tD34kGqn')"></div>
        <div class="c-p" style="position: absolute; top: 45%;left: 51%;width: 17%;height: 12%;" @click="goUrl('http://dwz.cn/DUPWzzWK')"></div>
        <div class="c-p" style="position: absolute; top: 45%;left: 70%;width: 17%;height: 12%;" @click="goUrl('http://dwz.cn/oikNHrLK')"></div>
